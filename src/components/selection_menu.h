...
void create_selection_menu(GtkWidget *grid)
{
    ...
    *background_box,
    ...
    gtk_widget_set_size_request(menu_box, 300, 550);
    ...
    // Create the logo
    avatar = gtk_image_new_from_file("D:\\music\\assets\\header_logo.png");
    gtk_widget_set_size_request(avatar, 300, 150);
    ...
    gtk_widget_set_size_request(background_box, 300, 550);
    ...
    gtk_css_provider_load_from_path(provider, "src\\components\\properties\\selection_menu.css", &error);
